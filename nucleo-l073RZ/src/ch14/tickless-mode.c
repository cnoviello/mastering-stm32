...
static const uint32_t ulPeriodValueForOneTick = 15;
...
/* Override the default definition of vPortSetupTimerInterrupt() that is weakly
 defined in the FreeRTOS Cortex-M0 port layer with a version that configures TIM6
