...
#define APP_START_ADDRESS   0x08004000 /* In STM32L073RZ this corresponds with the start
                                        address of Page 128 */

#define SRAM_SIZE           20*1024     // STM32L073RZ has 20KB of RAM
#define SRAM_END            (SRAM_BASE + SRAM_SIZE)
#define FLASH_TOTAL_PAGES   1535
...
void CHECK_AND_SET_FLASH_PROTECTION(void) {
  ...
  if ((obConfig.WRPSector & SECTORS_TO_PROTECT) == SECTORS_TO_PROTECT) {
    ...
    obConfig.WRPSector = SECTORS_TO_PROTECT; //Enables WP on first pages
