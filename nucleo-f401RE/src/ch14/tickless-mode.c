...
/* Calculate how many clock increments make up a single tick period.
 Since we are using a prescaler equal to 3499, and assuming a clock
 speed of 84MHz, according the equation [1] in Chapter 11 this
 period value ensure a timer overflow ever 1ms. */
static const uint32_t ulMaximumPrescalerValue = 3499;
static const uint32_t ulPeriodValueForOneTick = 23;
